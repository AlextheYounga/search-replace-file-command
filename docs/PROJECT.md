...
This is a new WP CLI command I am making that allows a person to search and replace strings in a Wordpress DB SQL file. 
...
- https://github.com/wp-cli/search-replace-command/pull/236
